...
const AgentsGrid = () => {
  const agents = [
    ...
    {
      name: "InterfaceForge",
      description: "The UI/UX Virtuoso. Crafts seamless interfaces and responsive experiences that adapt to every device.",
      color: "purple" as const,
      delay: 0.8,
      image: "insterfaceforge.jpg",
    },
  ];
